...
![users 테이블 생성](/posts/Penetration%20Testing%20%7C%20Week%203/1.webp)

`users` 테이블에는 다음과 같이 시험용 계정 `test`/`test`가 저장되어 있다.

<img src="/posts/Penetration%20Testing%20%7C%20Week%203/2.webp" alt="users 테이블" style="padding: 0 25%; background-color: white">
...
<img src="/posts/Penetration%20Testing%20%7C%20Week%203/3.webp" alt="users 테이블" style="padding: 0 8%; background-color: white">
