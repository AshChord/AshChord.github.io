...
![XSS CTF](/posts/Penetration%20Testing%20%7C%20Week%209/1.webp)
...
![XSS 1](/posts/Penetration%20Testing%20%7C%20Week%209/4.webp)

게시판의 동작 방식에 따라 입력한 데이터가 자연스럽게 게시물 목록에 출력되는 것을 알 수 있다.

![XSS 1](/posts/Penetration%20Testing%20%7C%20Week%209/5.webp)
![XSS 1](/posts/Penetration%20Testing%20%7C%20Week%209/6.webp)
...
![XSS 1](/posts/Penetration%20Testing%20%7C%20Week%209/7.webp)
...
![XSS 1](/posts/Penetration%20Testing%20%7C%20Week%209/8.webp)
...
![XSS 1](/posts/Penetration%20Testing%20%7C%20Week%209/9.webp)

서버 응답에 스크립트가 정상적으로 포함되어 있는 것을 확인하였다.

![XSS 1](/posts/Penetration%20Testing%20%7C%20Week%209/10.webp)
...
![XSS 2](/posts/Penetration%20Testing%20%7C%20Week%209/14.webp)

그러나 검색어는 화면에 출력되지 않았다. 따라서 예상했던 동작 방식이 실제 구현과 다르다는 사실을 확인하였으나, 검색 결과가 반환되지 않은 점에 의문이 들어 패킷을 확인해 보았다.

![XSS 2](/posts/Penetration%20Testing%20%7C%20Week%209/15.webp)
...
![XSS 2](/posts/Penetration%20Testing%20%7C%20Week%209/16.webp)
...
![XSS 2](/posts/Penetration%20Testing%20%7C%20Week%209/17.webp)

요청 전송 시 우클릭을 통해 컨텍스트 메뉴를 열면 요청 방식을 변경할 수 있는 항목이 존재한다.

![XSS 2](/posts/Penetration%20Testing%20%7C%20Week%209/18.webp)

요청 방식을 GET 방식으로 변경하여 전송하면 정상적으로 서버 응답이 반환되는 것을 확인할 수 있으며, 해당 요청의 URL 역시 추출할 수 있다.

![XSS 2](/posts/Penetration%20Testing%20%7C%20Week%209/19.webp)
![XSS 2](/posts/Penetration%20Testing%20%7C%20Week%209/20.webp)
...
![XSS 3](/posts/Penetration%20Testing%20%7C%20Week%209/22.webp)
...
![XSS 3](/posts/Penetration%20Testing%20%7C%20Week%209/23.webp)
...
![XSS 3](/posts/Penetration%20Testing%20%7C%20Week%209/24.webp)

서버 응답에 스크립트가 정상적으로 포함되는 것을 확인하였다. 이 방식 또한 Reflected XSS에 해당하므로, 해당 요청의 URL로 접속해 스크립트가 실행되는지 재확인해 보았다.

![XSS 3](/posts/Penetration%20Testing%20%7C%20Week%209/25.webp)
...
![XSS 4](/posts/Penetration%20Testing%20%7C%20Week%209/29.webp)
...
![XSS 4](/posts/Penetration%20Testing%20%7C%20Week%209/30.webp)

예상한대로 `<script>` 태그가 정상적으로 반환되었다. 다음으로 `<scrscriptipt>alert(1);</scrscriptipt>`을 사용하여 스크립트 실행을 시도하였다. 

![XSS 4](/posts/Penetration%20Testing%20%7C%20Week%209/31.webp)

`alert` 문자열 역시 필터링되고 있음을 확인하였다. 마찬가지 방법으로 `<scrscriptipt>alalertert(1);</scrscriptipt>`를 대신 사용하였다.

![XSS 4](/posts/Penetration%20Testing%20%7C%20Week%209/32.webp)

서버 응답에 스크립트가 정상적으로 포함되어 있는 것을 확인하였다.

![XSS 4](/posts/Penetration%20Testing%20%7C%20Week%209/33.webp)
...
![XSS 5](/posts/Penetration%20Testing%20%7C%20Week%209/35.webp)
...
![XSS 5](/posts/Penetration%20Testing%20%7C%20Week%209/36.webp)
![XSS 5](/posts/Penetration%20Testing%20%7C%20Week%209/37.webp)
...
![XSS 5](/posts/Penetration%20Testing%20%7C%20Week%209/38.webp)

서버 응답에 스크립트가 정상적으로 포함되어 있는 것을 확인하였다.

![XSS 5](/posts/Penetration%20Testing%20%7C%20Week%209/39.webp)
...
![XSS 6](/posts/Penetration%20Testing%20%7C%20Week%209/41.webp)
...
![XSS 6](/posts/Penetration%20Testing%20%7C%20Week%209/42.webp)

회원 가입에 성공하였다. 이후 로그인 페이지에서 `<script>alert(1);</script>`/`any`를 입력하여 로그인을 시도하였다.

![XSS 6](/posts/Penetration%20Testing%20%7C%20Week%209/43.webp)
...
![XSS 6](/posts/Penetration%20Testing%20%7C%20Week%209/44.webp)

서버 응답에 스크립트가 정상적으로 포함되는 것을 확인하였다. 이 방식 또한 Reflected XSS에 해당하므로, 해당 요청의 URL로 접속해 스크립트가 실행되는지 재확인해 보았다.

![XSS 6](/posts/Penetration%20Testing%20%7C%20Week%209/45.webp)
![XSS 6](/posts/Penetration%20Testing%20%7C%20Week%209/46.webp)
...
<a href="/posts/Penetration%20Testing%20%7C%20Week%209/XSS 취약점 점검 결과 보고서.pdf" download>XSS 취약점 점검 결과 보고서</a>