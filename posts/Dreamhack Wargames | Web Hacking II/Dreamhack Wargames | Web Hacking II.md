...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/1.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/2.webp)

첨부 파일을 다운로드한 뒤 소스 코드를 확인하며 각 페이지가 수행하는 기능을 파악해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/3.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/4.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/5.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/6.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/7.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/8.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/9.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/10.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/11.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/12.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/13.webp)

csrf-1과 비교하면, `/memo`와 `/admin/notice_flag` 대신 `/login` 페이지가 존재함을 알 수 있다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/14.webp)

`/login` 엔드포인트는 일반적인 로그인 페이지에 해당한다. 계정 정보와 로그인 로직 등을 파악하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/15.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/16.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/17.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/18.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/19.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/20.webp)

로그인 로직을 파악하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/21.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/22.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/23.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/24.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/25.webp)

화면에 출력되는 `/login?uid=guest&upw=guest`라는 주소로 이동해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/26.webp)

`guest` 문자열이 출력된다. `uid`와 `upw` 파라미터에 계정 정보를 전달하면 로그인을 수행한 뒤 로그인된 계정을 출력하는 구조로 추측된다. 구체적인 처리 과정을 파악하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/27.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/28.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/29.webp)
...
<pre><button class="copy-button"></button><code class="language-python" highlighted><data class="code-line" value="1"><span class="hljs-comment"># mango.py</span>
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/30.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/31.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/32.webp)

`8.8.8.8`을 입력하고 `Ping!` 버튼을 클릭하면 결과를 확인할 수 있다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/33.webp)

Command Injection을 통해 플래그를 획득하는 문제이므로, 우선 소스 코드를 다운로드하여 해당 페이지의 동작을 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/34.webp)
...
<pre><button class="copy-button"></button><code class="language-bash" highlighted><data class="code-line" value="1"><span class="hljs-comment"># host</span>
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/35.webp)

개발자 도구로 해당 입력란을 확인해 보면, `pattern` 속성을 통해 특정 정규식과 일치하는 값만이 입력 가능하도록 설정되어 있음을 알 수 있다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/36.webp)

하지만 이 제약 조건은 서버에서 검증하는 것이 아니므로 실질적인 효과가 없다. 실제로 HTML 코드를 수정해 `pattern` 속성을 제거한 뒤 `Ping!` 버튼을 클릭하면 정상적으로 양식이 제출된다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/37.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/38.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/39.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/40.webp)

예시 이미지를 업로드하면 다음과 같이 `uploads` 디렉터리에 저장되었다는 메시지가 출력된다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/41.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/42.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/43.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/44.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/45.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/46.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/47.webp)

업로드한 메모 파일은 메인 페이지에서 확인 가능하며, 링크를 클릭하면 `/read` 엔드포인트를 통해 해당 메모의 내용을 조회할 수 있다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/48.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/49.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/50.webp)

File Download 취약점이 존재한다고 하였으므로 이를 검증하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/51.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/52.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/53.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/54.webp)

SSRF 취약점을 찾아내기 위해 첨부 파일을 다운로드한 뒤 소스 코드를 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/55.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/56.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/57.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/58.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/59.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/60.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/61.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/62.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20II/63.webp)
