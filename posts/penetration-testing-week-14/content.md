...
![Web Shell](/posts/penetration-testing-week-14/assets/1.webp)

파일 업로드 기능이 포함된 간단한 게시판 애플리케이션이다. 앞서 작성했던 `webshell.php` 파일을 업로드해 보자.

![Web Shell](/posts/penetration-testing-week-14/assets/2.webp)
![Web Shell](/posts/penetration-testing-week-14/assets/3.webp)
...
![Web Shell](/posts/penetration-testing-week-14/assets/4.webp)
...
![multipart/form-data](/posts/penetration-testing-week-14/assets/5.webp){:style="padding: 0 15%; background-color: #2b2b2b;"}
...
![File Vuln CTF](/posts/penetration-testing-week-14/assets/6.webp)
...
![Web Shell 1](/posts/penetration-testing-week-14/assets/7.webp){:style="padding: 0 25%; background-color: white;"}

링크를 통해 접속하면 다음과 같은 회원제 게시판 애플리케이션으로 이동한다.

![Web Shell 1](/posts/penetration-testing-week-14/assets/8.webp)

회원 가입을 진행하여 `any`/`any` 계정을 생성하고, 로그인 후 게시물 작성 페이지로 이동하였다.

![Web Shell 1](/posts/penetration-testing-week-14/assets/9.webp)

파일 업로드 기능이 포함되어 있는 것을 확인할 수 있다. 앞서 활용했던 `webshell.php` 파일을 업로드하고 게시물을 열람해 보았다.

![Web Shell 1](/posts/penetration-testing-week-14/assets/10.webp)
...
![Web Shell 1](/posts/penetration-testing-week-14/assets/11.webp)

웹 셸이 실행되어 현재 디렉터리에 존재하는 파일들이 출력되었다. 다음으로 `flag.txt` 파일을 찾기 위해 `cmd` 파라미터의 값으로 다음 구문을 사용하였다.

<pre><button class="copy-button"></button><code class="language-bash" highlighted><data class="code-line" value="1"><span class="hljs-comment"># find: 파일/디렉터리 검색 명령어</span>
...
![Web Shell 1](/posts/penetration-testing-week-14/assets/12.webp)
...
![Web Shell 1](/posts/penetration-testing-week-14/assets/13.webp)
...
![Web Shell 2](/posts/penetration-testing-week-14/assets/14.webp){:style="padding: 0 25%; background-color: white;"}

![Web Shell 1](/posts/penetration-testing-week-14/assets/15.webp)
![Web Shell 1](/posts/penetration-testing-week-14/assets/16.webp)
![Web Shell 1](/posts/penetration-testing-week-14/assets/17.webp)
![Web Shell 1](/posts/penetration-testing-week-14/assets/18.webp)
![Web Shell 1](/posts/penetration-testing-week-14/assets/19.webp)
![Web Shell 1](/posts/penetration-testing-week-14/assets/20.webp)
![Web Shell 1](/posts/penetration-testing-week-14/assets/21.webp)
![Web Shell 1](/posts/penetration-testing-week-14/assets/22.webp)
![Web Shell 1](/posts/penetration-testing-week-14/assets/23.webp)
