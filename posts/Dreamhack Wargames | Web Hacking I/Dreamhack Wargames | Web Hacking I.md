...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/1.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/2.webp)

대부분의 웹 페이지에서 진입점 페이지에 해당하는 `index.html` 파일을 브라우저를 사용하여 열람해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/3.webp)

개발자 도구의 Sources 탭 기능을 활용하여 `DH{...}` 형식의 플래그를 찾아야 하므로, `DH` 문자열을 검색함으로써 소스 내에 존재하는 플래그를 발견할 수 있을 것으로 예상된다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/4.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/5.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/6.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/7.webp)

호박 이미지를 10,000번 클릭하면 플래그가 출력될 확률이 높으나 시간적 소모가 상당할 것이므로, 이를 우회하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/8.webp)
...
해당 조건문을 살펴보면, `counter` 변수의 값이 100의 배수일 경우 `pumpkin` 배열과 `pie` 변수를 대상으로 복잡한 연산이 수행된다. 즉, 클릭이 100회 발생할 때마다 `pumpkin` 및 `pie` 값의 재조정 과정이 반복적으로 실행되는 구조이다.

이에 따른 간단한 해결 방안으로, 매 클릭 시 `counter` 변수가 100씩 증가하도록 코드를 수정(`counter += 100`)한 후 100회 클릭을 수행하여 동작을 검증해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/9.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/10.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/11.webp)

소스 코드를 확인해 보면, 다음과 같은 JavaScript 코드가 존재한다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/12.webp)

분석 대상인 `main()` 함수가 난독화되어 있어 동작을 파악하기 어려웠으므로, 실제로 데이터를 입력한 후 브라우저의 개발자 도구를 활용하여 `main()` 함수를 실행 상태에서 디버깅해 보기로 결정하였다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/13.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/14.webp)

위와 같이 `main()` 함수에 중단점을 설정한 후, `test` 문자열을 입력하고 제출해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/15.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/16.webp)
...
```
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/17.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/18.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/19.webp)

무작위 생년월일을 입력한 뒤 `Confirm` 버튼을 누르면 다음과 같이 알림 창에 `Wrong` 메시지가 표시된다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/20.webp)

웹 사이트의 동작을 분석하기 위해 소스 코드를 확인해 보았다. JavaScript 코드 전체가 난독화되어 있고 분량이 매우 방대한 관계로 분석 과정에서 핵심적으로 살펴본 부분만을 발췌하였다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/21.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/22.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/23.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/24.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/25.webp)

`Login` 버튼을 클릭하면 로그인 화면으로 이동한다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/26.webp)

목표는 admin 계정으로 로그인하는 것이지만, 현재로서는 파악된 정보가 전무한 상태이므로 우선 첨부 파일을 다운로드하여 소스 코드를 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/27.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/28.webp)

`guest`/`guest`를 입력하고 로그인하면 메인 페이지로 이동하며 `you are not admin`이라는 메시지가 출력된다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/29.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/30.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/31.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/32.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/33.webp)

admin 계정으로 로그인하기 위한 단서를 찾기 위해 첨부 파일을 다운로드하여 소스 코드를 확인해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/34.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/35.webp)

`guest`/`guest`를 입력하여 guest 계정으로 로그인한다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/36.webp)

`/admin` 주소에 접근하여 admin 계정의 세션 ID를 획득한다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/37.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/38.webp)

개발자 도구를 통해 쿠키 값에 저장된 guest 계정의 세션 ID를 admin 계정의 세션 ID로 수정한다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/39.webp)
...
![Description](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/40.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/41.webp)

첨부 파일을 다운로드한 뒤 소스 코드를 확인하며 각 페이지가 수행하는 기능을 파악해 보았다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/42.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/43.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/44.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/45.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/46.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/47.webp)
...
`flag()` 함수는 내부에서 `check_xss()` 함수를 통해 `read_url()`을 호출하며, 이 과정에서 봇은 사용자가 입력한 `param` 값을 포함한 채 로컬 호스트의 `/vuln` 엔드포인트에 접속하게 된다. 이때 플래그 값이 `cookie` 파라미터를 통해 봇의 쿠키에 저장되므로, 해당 쿠키 값을 탈취하면 플래그를 획득할 수 있다.
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/48.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/49.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/50.webp)

xss-1과의 유일한 차이점은 `/vuln` 엔드포인트에서 확인할 수 있다.

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/51.webp)
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/52.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/53.webp)

그러나 실제로 `/vuln` 엔드포인트에 접근하면 `param` 파라미터에 전달된 스크립트가 실행되지 않아 알림 창이 표시되지 않는 것을 확인할 수 있다. 그 이유가 무엇일까?

![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/54.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/55.webp)
...
![Write-Up](/data/Dreamhack%20Wargames%20|%20Web%20Hacking%20I/56.webp)
