...
> **Web Server - WAS - DB**
> ![Web Application Architecture 구조](/posts/penetration-testing-week-1/assets/1.webp)
...
![GET 방식](/posts/penetration-testing-week-1/assets/3.webp)
...
![POST 방식](/posts/penetration-testing-week-1/assets/4.webp)
...
![UTM 설치](/posts/penetration-testing-week-1/assets/5.webp)
...
![Ubuntu 설치](/posts/penetration-testing-week-1/assets/6.webp)
...
![Remote - SSH](/posts/penetration-testing-week-1/assets/7.webp)
...
</data><data class="code-line" value="14" style="--indent: 4ch;"><span style="color:#24292E">    $message </span><span style="color:#D73A49">=</span><span style="color:#032F62"> "&lt;p style='color: green;'&gt;Login Successful!&lt;/p&gt;"</span><span style="color:#24292E">;</span>
</data><data class="code-line" value="15" style="--indent: 2ch;"><span style="color:#24292E">  } </span><span style="color:#D73A49">else</span><span style="color:#24292E"> {</span>
</data><data class="code-line" value="16" style="--indent: 4ch;"><span style="color:#6A737D">    // Failed Login Message</span>
</data><data class="code-line" value="17" style="--indent: 4ch;"><span style="color:#24292E">    $message </span><span style="color:#D73A49">=</span><span style="color:#032F62"> "&lt;p style='color: red;'&gt;Login Failed. Please Try Again.&lt;/p&gt;"</span><span style="color:#24292E">;</span>
...
![로그인 페이지](/posts/penetration-testing-week-1/assets/8.webp)

올바른 아이디와 비밀번호를 입력하면 로그인 성공 메시지가 출력된다.

![로그인 성공](/posts/penetration-testing-week-1/assets/9.webp)

잘못된 정보를 입력한 경우 로그인 실패 메시지가 출력된다.

![로그인 실패](/posts/penetration-testing-week-1/assets/10.webp)