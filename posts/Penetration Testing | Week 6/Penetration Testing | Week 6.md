...
![ORDER BY](/posts/Penetration%20Testing%20%7C%20Week%206/1.webp)
...
![게임 검색 사이트](/posts/Penetration%20Testing%20%7C%20Week%206/2.webp)
...
![SQL Injection 지점 식별](/posts/Penetration%20Testing%20%7C%20Week%206/3.webp)
...
![SQL Injection 지점 식별](/posts/Penetration%20Testing%20%7C%20Week%206/4.webp)
...
![SQL Injection 지점 식별](/posts/Penetration%20Testing%20%7C%20Week%206/5.webp)
...
![SQL Injection 지점 식별](/posts/Penetration%20Testing%20%7C%20Week%206/6.webp)
...
![컬럼 수 파악](/posts/Penetration%20Testing%20%7C%20Week%206/7.webp)

`Over%' order by 4#`까지는 정상적으로 결과가 반환된다.

![컬럼 수 파악](/posts/Penetration%20Testing%20%7C%20Week%206/8.webp)
...
![출력 컬럼 위치 식별](/posts/Penetration%20Testing%20%7C%20Week%206/9.webp)
...
![데이터베이스 이름 식별](/posts/Penetration%20Testing%20%7C%20Week%206/10.webp)
...
![데이터베이스 이름 추출](/posts/Penetration%20Testing%20%7C%20Week%206/11.webp)
...
![테이블 이름 추출](/posts/Penetration%20Testing%20%7C%20Week%206/12.webp)
...
![컬럼 이름 추출](/posts/Penetration%20Testing%20%7C%20Week%206/13.webp)
...
![컬럼 이름 추출](/posts/Penetration%20Testing%20%7C%20Week%206/14.webp)
...
![Authentication Bypass & SQL Injection CTF](/posts/Penetration%20Testing%20%7C%20Week%206/15.webp)
...
![Login Bypass 3](/posts/Penetration%20Testing%20%7C%20Week%206/17.webp)
![Login Bypass 3](/posts/Penetration%20Testing%20%7C%20Week%206/18.webp)
...
![Login Bypass 3](/posts/Penetration%20Testing%20%7C%20Week%206/19.webp)
![Login Bypass 3](/posts/Penetration%20Testing%20%7C%20Week%206/20.webp)
...
![Login Bypass 3](/posts/Penetration%20Testing%20%7C%20Week%206/21.webp)

`UNION`을 이용한 공격은 로그인에 성공하였다. 이제 아이디 값만 `normaltic3`로 변경하면 문제 해결이 완료된다. 우선 첫 번째 컬럼이 아이디라고 가정하고 로그인을 시도하였다.

![Login Bypass 3](/posts/Penetration%20Testing%20%7C%20Week%206/22.webp)
![Login Bypass 3](/posts/Penetration%20Testing%20%7C%20Week%206/23.webp)
...
![Login Bypass 4](/posts/Penetration%20Testing%20%7C%20Week%206/25.webp)

`hash_algos()` 함수를 이용하면 PHP에서 지원하는 해시 알고리즘의 목록을 확인할 수 있다고 한다. 바로 `hash_algos()` 함수에 대해서도 조사해 보았다.

![Login Bypass 4](/posts/Penetration%20Testing%20%7C%20Week%206/26.webp)
...
![Login Bypass 4](/posts/Penetration%20Testing%20%7C%20Week%206/27.webp)
...
![Login Bypass 4](/posts/Penetration%20Testing%20%7C%20Week%206/28.webp)

그 결과, 첫 번째 시도에서 로그인이 성공적으로 수행되었다. 이제 아이디만 `normaltic4`로 변경하면 문제 해결이 완료된다.

![Login Bypass 4](/posts/Penetration%20Testing%20%7C%20Week%206/29.webp)
![Login Bypass 4](/posts/Penetration%20Testing%20%7C%20Week%206/30.webp)
...
![Login Bypass 5](/posts/Penetration%20Testing%20%7C%20Week%206/32.webp)

앞선 Login Bypass 문제들과는 다르게 서버 응답의 `Set-Cookie` 헤더에 `loginUser=doldol` 값이 설정되어 있음을 확인하였다.

![Login Bypass 5](/posts/Penetration%20Testing%20%7C%20Week%206/33.webp)
...
![Login Bypass 5](/posts/Penetration%20Testing%20%7C%20Week%206/34.webp)
...
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/36.webp)
...
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/37.webp)

입력한 검색어가 GET 방식으로 서버에 전달되어 SQL 쿼리에 삽입되는 구조로 예상되었다. SQL Injection이 가능한지 확인하기 위해 검색어로 `Adminer' and '1' = '1`를 입력해 보았다.

![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/38.webp)
...
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/39.webp)

예상대로 `Admin`만 입력해도 성공적으로 검색이 수행되었다. 이에 따라 페이로드를 `Admin%' and '1%' = '1`로 변경하여 입력해 보았다.

![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/40.webp)
...
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/41.webp)
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/42.webp)
...
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/43.webp)
...
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/44.webp)
...
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/45.webp)
...
![SQL Injection 1](/posts/Penetration%20Testing%20%7C%20Week%206/46.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/49.webp)

예시 데이터들이 출력되는 대신 `normaltic`이라는 예시 검색어가 검색란에 표시되어 있었다. 바로 검색을 수행해 보았다.

![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/50.webp)

아이디가 `normaltic`인 사용자 정보가 출력되었다. SQL Injection 공격이 가능한지 검토하기 위해 `normaltic' and '1' = '1`을 입력해 보았다.

![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/51.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/52.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/53.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/54.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/55.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/56.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/57.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/58.webp)
...
![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/59.webp)

이번에도 플래그를 획득할 수 없었다. 따라서 `flag` 컬럼에 존재하는 다른 값이 있는지 확인해 보았다.

![SQL Injection 2](/posts/Penetration%20Testing%20%7C%20Week%206/60.webp)
