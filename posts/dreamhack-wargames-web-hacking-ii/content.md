...
![Description](/posts/dreamhack-wargames-web-hacking-ii/assets/1.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/2.webp)

첨부 파일을 다운로드한 뒤 소스 코드를 확인하며 각 페이지가 수행하는 기능을 파악해 보았다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/3.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/4.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/5.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/6.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/7.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/8.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/9.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/10.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/11.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/12.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/13.webp)

csrf-1과 비교하면, `/memo`와 `/admin/notice_flag` 대신 `/login` 페이지가 존재함을 알 수 있다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/14.webp)

`/login` 엔드포인트는 일반적인 로그인 페이지에 해당한다. 계정 정보와 로그인 로직 등을 파악하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/15.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/16.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/17.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/18.webp)
...
![Description](/posts/dreamhack-wargames-web-hacking-ii/assets/19.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/20.webp)

로그인 로직을 파악하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/21.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/22.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/23.webp)
...
![Description](/posts/dreamhack-wargames-web-hacking-ii/assets/24.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/25.webp)

화면에 출력되는 `/login?uid=guest&upw=guest`라는 주소로 이동해 보았다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/26.webp)

`guest` 문자열이 출력된다. `uid`와 `upw` 파라미터에 계정 정보를 전달하면 로그인을 수행한 뒤 로그인된 계정을 출력하는 구조로 추측된다. 구체적인 처리 과정을 파악하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/27.webp)
...
<style id="code-1">
  #code-1 + pre data[value="2"] span {color: #24292E !important;}
</style>
```js
// Query String:
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/28.webp)
...
<style id="code-2">
  #code-2 + pre data[value="2"] span {color: #24292E !important;}
</style>
```js
// Query String:
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/29.webp)
...
<style id="code-3">
  #code-3 + pre data[value="8"] span:nth-of-type(1) {color: #24292E !important;}
  #code-3 + pre data[value="12"] span:nth-of-type(7) {color: #24292E !important;}
  #code-3 + pre data[value="14"] span:nth-of-type(1) {color: #24292E !important;}
  #code-3 + pre data[value="17"] span:nth-of-type(5) {color: #24292E !important;}
</style>
```python
# mango.py
...
url = "http://host1.dreamhack.games:14943/login"
query = "?uid[$regex]=^adm&upw[$regex]=^..{"
str = ""
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/30.webp)
...
![Description](/posts/dreamhack-wargames-web-hacking-ii/assets/31.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/32.webp)

`8.8.8.8`을 입력하고 `Ping!` 버튼을 클릭하면 결과를 확인할 수 있다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/33.webp)

Command Injection을 통해 플래그를 획득하는 문제이므로, 우선 소스 코드를 다운로드하여 해당 페이지의 동작을 확인해 보았다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/34.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/35.webp)

개발자 도구로 해당 입력란을 확인해 보면, `pattern` 속성을 통해 특정 정규식과 일치하는 값만이 입력 가능하도록 설정되어 있음을 알 수 있다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/36.webp)

하지만 이 제약 조건은 서버에서 검증하는 것이 아니므로 실질적인 효과가 없다. 실제로 HTML 코드를 수정해 `pattern` 속성을 제거한 뒤 `Ping!` 버튼을 클릭하면 정상적으로 양식이 제출된다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/37.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/38.webp)
...
![Description](/posts/dreamhack-wargames-web-hacking-ii/assets/39.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/40.webp)

예시 이미지를 업로드하면 다음과 같이 `uploads` 디렉터리에 저장되었다는 메시지가 출력된다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/41.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/42.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/43.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/44.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/45.webp)
...
![Description](/posts/dreamhack-wargames-web-hacking-ii/assets/46.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/47.webp)

업로드한 메모 파일은 메인 페이지에서 확인 가능하며, 링크를 클릭하면 `/read` 엔드포인트를 통해 해당 메모의 내용을 조회할 수 있다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/48.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/49.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/50.webp)

File Download 취약점이 존재한다고 하였으므로 이를 검증하기 위해 소스 코드를 확인해 보았다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/51.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/52.webp)
...
![Description](/posts/dreamhack-wargames-web-hacking-ii/assets/53.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/54.webp)

SSRF 취약점을 찾아내기 위해 첨부 파일을 다운로드한 뒤 소스 코드를 확인해 보았다.

![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/55.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/56.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/57.webp)
...
> - {:style="margin-bottom: 0;"} Flask에서 정적 파일을 제공할 때에는 기본적으로 `static` 디렉터리 하위 경로에 한정하여 접근을 허용하며, 그 외 경로의 파일은 별도의 설정이 없는 한 외부에 노출되지 않는다. 이는 Flask가 동적 애플리케이션 처리 중심으로 설계되었기 때문에, 정적 파일 제공은 특별히 지정된 위치에서만 이루어지도록 제한된 동작이다.
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/58.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/59.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/60.webp)
...
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/61.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/62.webp)
![Write-Up](/posts/dreamhack-wargames-web-hacking-ii/assets/63.webp)
