...
Flag: <span style="color: green">segfault{<span style="filter: blur(5px); overflow-wrap:anywhere;">csrfEEASY?</span>}</span>
...
Flag: <span style="color: green">segfault{<span style="filter: blur(5px); overflow-wrap:anywhere;">postCSRFkkk</span>}</span>
{:style="text-align: center;"}
...
Flag: <span style="color: green">segfault{<span style="filter: blur(5px); overflow-wrap:anywhere;">csrfTokenByp4ss</span>}</span>
{:style="text-align: center;"}