...
<script>
  (() => {
    ...
    const companyRanking = script.previousElementSibling;
    const stockList = companyRanking.previousElementSibling;
    ...
    for (const [table, text] of [
      ...
      caption.style.cssText = 'margin-bottom: 24px; text-align: left; font-weight: bold;';
...
![ORDER BY](/posts/penetration-testing-week-6/assets/1.webp)
...
![게임 검색 사이트](/posts/penetration-testing-week-6/assets/2.webp)
...
![SQL Injection 지점 식별](/posts/penetration-testing-week-6/assets/3.webp)
...
![SQL Injection 지점 식별](/posts/penetration-testing-week-6/assets/4.webp)
...
![SQL Injection 지점 식별](/posts/penetration-testing-week-6/assets/6.webp)
...
![컬럼 수 파악](/posts/penetration-testing-week-6/assets/7.webp)

`Over%' order by 4#`까지는 정상적으로 결과가 반환된다.

![컬럼 수 파악](/posts/penetration-testing-week-6/assets/8.webp)
...
![출력 컬럼 위치 식별](/posts/penetration-testing-week-6/assets/9.webp)
...
![데이터베이스 이름 식별](/posts/penetration-testing-week-6/assets/10.webp)
...
![데이터베이스 이름 추출](/posts/penetration-testing-week-6/assets/11.webp)
...
![테이블 이름 추출](/posts/penetration-testing-week-6/assets/12.webp)
...
![컬럼 이름 추출](/posts/penetration-testing-week-6/assets/13.webp)
...
![컬럼 이름 추출](/posts/penetration-testing-week-6/assets/14.webp)
...
![Authentication Bypass & SQL Injection CTF](/posts/penetration-testing-week-6/assets/15.webp)
...
![Login Bypass 3](/posts/penetration-testing-week-6/assets/19.webp)
![Login Bypass 3](/posts/penetration-testing-week-6/assets/20.webp)
...
![Login Bypass 3](/posts/penetration-testing-week-6/assets/21.webp)

`UNION`을 이용한 공격은 로그인에 성공하였다. 이제 아이디 값만 `normaltic3`로 변경하면 문제 해결이 완료된다. 우선 첫 번째 컬럼이 아이디라고 가정하고 로그인을 시도하였다.

![Login Bypass 3](/posts/penetration-testing-week-6/assets/22.webp)
![Login Bypass 3](/posts/penetration-testing-week-6/assets/23.webp)
...
![Login Bypass 4](/posts/penetration-testing-week-6/assets/25.webp)

`hash_algos()` 함수를 이용하면 PHP에서 지원하는 해시 알고리즘의 목록을 확인할 수 있다고 한다. 바로 `hash_algos()` 함수에 대해서도 조사해 보았다.

![Login Bypass 4](/posts/penetration-testing-week-6/assets/26.webp)
...
![Login Bypass 4](/posts/penetration-testing-week-6/assets/27.webp)
...
![Login Bypass 4](/posts/penetration-testing-week-6/assets/28.webp)

그 결과, 첫 번째 시도에서 로그인이 성공적으로 수행되었다. 이제 아이디만 `normaltic4`로 변경하면 문제 해결이 완료된다.

![Login Bypass 4](/posts/penetration-testing-week-6/assets/29.webp)
![Login Bypass 4](/posts/penetration-testing-week-6/assets/30.webp)
...
![Login Bypass 5](/posts/penetration-testing-week-6/assets/33.webp)
...
![Login Bypass 5](/posts/penetration-testing-week-6/assets/34.webp)
...
![SQL Injection 1](/posts/penetration-testing-week-6/assets/37.webp)

입력한 검색어가 GET 방식으로 서버에 전달되어 SQL 쿼리에 삽입되는 구조로 예상되었다. SQL Injection이 가능한지 확인하기 위해 검색어로 `Adminer' and '1' = '1`를 입력해 보았다.

![SQL Injection 1](/posts/penetration-testing-week-6/assets/38.webp)
...
![SQL Injection 1](/posts/penetration-testing-week-6/assets/39.webp)

예상대로 `Admin`만 입력해도 성공적으로 검색이 수행되었다. 이에 따라 페이로드를 `Admin%' and '1%' = '1`로 변경하여 입력해 보았다.

![SQL Injection 1](/posts/penetration-testing-week-6/assets/40.webp)
...
![SQL Injection 1](/posts/penetration-testing-week-6/assets/41.webp)
![SQL Injection 1](/posts/penetration-testing-week-6/assets/42.webp)
...
![SQL Injection 1](/posts/penetration-testing-week-6/assets/43.webp)
...
![SQL Injection 1](/posts/penetration-testing-week-6/assets/44.webp)
...
![SQL Injection 1](/posts/penetration-testing-week-6/assets/45.webp)
...
![SQL Injection 1](/posts/penetration-testing-week-6/assets/46.webp)
...
![SQL Injection 1](/posts/penetration-testing-week-6/assets/47.webp)
...
![SQL Injection 2](/posts/penetration-testing-week-6/assets/50.webp)

아이디가 `normaltic`인 사용자 정보가 출력되었다. SQL Injection 공격이 가능한지 검토하기 위해 `normaltic' and '1' = '1`을 입력해 보았다.

![SQL Injection 2](/posts/penetration-testing-week-6/assets/51.webp)
...
![SQL Injection 2](/posts/penetration-testing-week-6/assets/52.webp)
...
![SQL Injection 2](/posts/penetration-testing-week-6/assets/53.webp)
...
![SQL Injection 2](/posts/penetration-testing-week-6/assets/55.webp)
...
![SQL Injection 2](/posts/penetration-testing-week-6/assets/56.webp)
...
![SQL Injection 2](/posts/penetration-testing-week-6/assets/57.webp)
...
![SQL Injection 2](/posts/penetration-testing-week-6/assets/58.webp)
...
![SQL Injection 2](/posts/penetration-testing-week-6/assets/59.webp)

이번에도 플래그를 획득할 수 없었다. 따라서 `flag` 컬럼에 존재하는 다른 값이 있는지 확인해 보았다.

![SQL Injection 2](/posts/penetration-testing-week-6/assets/60.webp)
