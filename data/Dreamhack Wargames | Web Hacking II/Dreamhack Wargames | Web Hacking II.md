...
<pre><code class="language-python" highlighted><data class="code-line" value="1"><span class="hljs-comment"># mango.py</span>
...
<pre><code class="language-bash" highlighted><data class="code-line" value="1"><span class="hljs-comment"># host</span>
