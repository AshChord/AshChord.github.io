...
>
> <pre class="dom-html"><code class="language-html" highlighted><data class="code-line" value="1"><span class="hljs-meta">&lt;!DOCTYPE <span class="hljs-keyword">html</span>&gt;</span>
...
> <pre class="dom-tree"><code class="language-text" highlighted><data class="code-line" value="1">document
