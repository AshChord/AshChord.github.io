...
> **Web Server - WAS - DB**
>
> ![Wep Application Architecture 구조](/data/Penetration%20Testing%3A%20Week%201/4.png)
...
<div style="text-align: center"><img src="/data/Penetration%20Testing%3A%20Week%201/5.png" alt="GET 방식 - 1" width="600"/></div>

입력 폼에 john을 입력하고 엔터를 누르면 다음과 같은 일이 발생한다.

<div style="text-align: center"><img src="/data/Penetration%20Testing%3A%20Week%201/6.png" alt="GET 방식 - 2" width="600"/></div>
...
<div style="text-align: center"><img src="/data/Penetration%20Testing%3A%20Week%201/5.png" alt="POST 방식" width="600"/></div>
...
![UTM 설치](/data/Penetration%20Testing%3A%20Week%201/1.png)
...
![Ubuntu 설치](/data/Penetration%20Testing%3A%20Week%201/2.png)
...
![Remote - SSH](/data/Penetration%20Testing%3A%20Week%201/3.png)
