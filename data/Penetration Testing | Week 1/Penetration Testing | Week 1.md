...
> **Web Server - WAS - DB**
>
> ![Wep Application Architecture 구조](/data/Penetration%20Testing%20%7C%20Week%201/4.png)
...
<div style="text-align: center"><img src="/data/Penetration%20Testing%20%7C%20Week%201/5.png" alt="GET 방식 - 1" width="600"/></div>

입력 폼에 john을 입력하고 엔터를 누르면 다음과 같은 일이 발생한다.

<div style="text-align: center"><img src="/data/Penetration%20Testing%20%7C%20Week%201/6.png" alt="GET 방식 - 2" width="600"/></div>
...
<div style="text-align: center"><img src="/data/Penetration%20Testing%20%7C%20Week%201/7.png" alt="POST 방식" width="600"/></div>
...
아파치 웹 서버의 루트 디렉토리 /var/www/html에서 login.php와 login_proc.php 파일을 생성하였다.
웹 페이지 디자인에는 CSS를 사용하였다.

login.php

<div style="text-align: center"><img src="/data/Penetration%20Testing%20%7C%20Week%201/8.png" alt="login.php" width="500"/></div>

login_proc.php

<div style="text-align: center"><img src="/data/Penetration%20Testing%20%7C%20Week%201/9.png" alt="login_proc.php" width="500"/></div>

실행 결과는 다음과 같다.

로그인 페이지

<div style="text-align: center"><img src="/data/Penetration%20Testing%20%7C%20Week%201/10.png" alt="로그인 페이지" width="600"/></div>

로그인 결과(성공)

<div style="text-align: center"><img src="/data/Penetration%20Testing%20%7C%20Week%201/11.png" alt="로그인 결과(성공)" width="600"/></div>

로그인 결과(실패)

<div style="text-align: center"><img src="/data/Penetration%20Testing%20%7C%20Week%201/12.png" alt="로그인 결과(실패)" width="600"/></div>