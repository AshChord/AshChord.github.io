...
<pre><code class="language-sql" highlighted><data class="code-line" value="1"><span class="hljs-keyword">SELECT</span> <span class="hljs-operator">*</span> <span class="hljs-keyword">FROM</span> user <span class="hljs-keyword">WHERE</span> username <span class="hljs-operator">=</span> <span class="hljs-string">'user'' AND password = '</span>1234'
</data></code><button class="copy-button"></button></pre>
...
<pre><code class="language-sql" highlighted><data class="code-line" value="1"><span class="hljs-comment">/* username: user */</span>
...
<pre><code class="language-sql" highlighted><data class="code-line" value="1"><span class="hljs-comment">/* username: user' or '1' = '1 */</span>
